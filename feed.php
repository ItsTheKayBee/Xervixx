...
<div id="tabLayout-icons">
    ...
    <a class="btn active feed-feed" onclick="filterSelection('all')" style="color:#2980b9;"><i class="fa fa-mobile" style="top: -15px;left:10px;position: relative;">&nbsp;</i>&nbsp;&nbsp;<span class="fa fa-caret-down flip" style="top: -15px;position: relative;color:#2980b9;"></span></a>
...
<div class="rows" id="feed-posts" style="top: 60px;"></div>
