...
<div id="tabLayout">
    <a class="btn btn_home" href="" style="border-left: 10px solid #d35400"><i class="fa fa-home"></i>&nbsp;Home</a>
    <a class="btn btn_feed active feed-feed" onclick="filterSelection('all')" style="border-left: 10px solid #2980b9"><i class="fa fa-mobile"></i>&nbsp;&nbsp;Feed &nbsp;<span class="fa fa-caret-down flip"></span></a>
    ...
    <a class="btn btn_quiz" href="" style="border-left: 10px solid #8e44ad"><i class="fa fa-question-circle"></i>&nbsp; Quiz</a>
    ...
    <div id="lower-menu">
        ...
        <a class="btn btn_logout" href="" style="border-left: 10px solid #c0392b"><i class="fa fa-power-off"></i>&nbsp;&nbsp;Logout&nbsp;</a>
    </div>
</div>
...
<div id="tabLayout-icons">
    <a class="btn" href="" style="color:#d35400; "><i class="fa fa-home"></i></a>
    ...
    <a class="btn" href="" style="color:#27ae60;"><i class="fa fa-chart-line"></i></a>
    <a class="btn" href="" style="color:#8e44ad;"><i class="fa fa-question-circle"></i></a>
...
<nav id="closeScoreLayout">
    ...
    <!-- <span class="fas fa-coins" id="display-btc" onclick="scoreLayout(this)" style="font-size:40px;color:gold;padding:10px;"></span>
    ...
    <div id="x-money-div">
        <!-- <h3 style="color: white; top: -10px;">Your x-money wallet balance is:</h3> -->
